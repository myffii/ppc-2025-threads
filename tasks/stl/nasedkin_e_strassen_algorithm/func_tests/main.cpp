...
void RunRandomMatrixTest(int size) {
  ...
  nasedkin_e_strassen_algorithm_stl::StrassenSequential strassen_task_sequential(task_data_seq);
...
void RunFixedMatrixTest(int size) {
  ...
  std::vector<double> expected_result = nasedkin_e_strassen_algorithm_stl::StandardMultiply(in_a, in_b, size);
  std::vector<double> out(size * size, 0.0);
...
TEST(nasedkin_e_strassen_algorithm_stl, test_random_matrix_64x64) { RunRandomMatrixTest(64); }

TEST(nasedkin_e_strassen_algorithm_stl, test_random_matrix_127x127) { RunRandomMatrixTest(127); }

TEST(nasedkin_e_strassen_algorithm_stl, test_random_matrix_128x128) { RunRandomMatrixTest(128); }