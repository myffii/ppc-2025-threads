...
vector<vector<int>> nasedkin_e_strassen_algorithm_seq::StrassenSequential::addMatrices(const vector<vector<int>>& A, const vector<vector<int>>& B) {
    int n = A.size();
...
vector<vector<int>> nasedkin_e_strassen_algorithm_seq::StrassenSequential::subtractMatrices(const vector<vector<int>>& A, const vector<vector<int>>& B) {
    int n = A.size();
    vector<vector<int>> result(n, vector<int>(n));
    for (int i = 0; i < n; i++) {
        for (int j = 0; j < n; j++) {
...
void nasedkin_e_strassen_algorithm_seq::StrassenSequential::splitMatrix(const vector<vector<int>>& parent, vector<vector<int>>& child, int rowStart, int colStart) {
...
void nasedkin_e_strassen_algorithm_seq::StrassenSequential::mergeMatrix(vector<vector<int>>& parent, const vector<vector<int>>& child, int rowStart, int colStart) {
    for (int i = 0; i < child.size(); i++) {
        for (int j = 0; j < child.size(); j++) {
...
vector<vector<int>> nasedkin_e_strassen_algorithm_seq::StrassenSequential::standardMultiply(const vector<vector<int>>& A, const vector<vector<int>>& B) {
    int n = A.size();
...
vector<vector<int>> nasedkin_e_strassen_algorithm_seq::StrassenSequential::strassenMultiply(const vector<vector<int>>& A, const vector<vector<int>>& B) {
    int n = A.size();
