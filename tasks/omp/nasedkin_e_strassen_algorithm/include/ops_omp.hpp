...
std::vector<double> StandardMultiply(const std::vector<double>& a, const std::vector<double>& b, int rows_a, int cols_a, int cols_b);
...
class StrassenOmp : public ppc::core::Task {
 ...
 private:
  static std::vector<double> AddMatrices(const std::vector<double>& a, const std::vector<double>& b, int rows, int cols);
  static std::vector<double> SubtractMatrices(const std::vector<double>& a, const std::vector<double>& b, int rows, int cols);
  ...
  static void MergeMatrix(std::vector<double>& parent, const std::vector<double>& child, int row_start, int col_start,
                          int parent_rows, int parent_cols);
  static std::vector<double> PadMatrix(const std::vector<double>& matrix, int orig_rows, int orig_cols, int new_rows, int new_cols);
  ...
  static std::vector<double> StrassenMultiply(const std::vector<double>& a, const std::vector<double>& b, 
